...
func NewSession(projectId string, instanceId string, databaseId string, priority sppb.RequestOptions_Priority, role string, directedRead *sppb.DirectedReadOptions, opts ...option.ClientOption) (*Session, error) {
...
func (s *Session) RunAnalyzeQuery(ctx context.Context, stmt spanner.Statement) (*sppb.QueryPlan, error) {
